...
<section>
<h1 >Entradas</h1>
<form action="../inventario/insert_entrada.php" role="form" method="POST" >  

  <div>
  <select name="origen" type="text" required> 
  ...
  <select name="prenda" required>
      ...
      <div>   
  <input name="cantidad" required  type="number" step=0.1 placeholder="Cantidad"> 
     </div>
      <div >     
