...
<div>
  <label for="origen">Origen de la prenda:</label>
</div>
<div>
  <input list="origen" name="origen"  type="text" > 
</div>
                  <datalist id="origen">      
...
<div>
  <input name="prenda"  type="text" list="prenda"> 
</div>  
  <datalist id="prenda">
...
<div>      
  <input name="cantidad" class="input" type="number" name="cantidad"> 
</div>
<br>
<tr><td colspan="2">
<br>
